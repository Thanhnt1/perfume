                            ...
                            @foreach ($productList['data'] as $item)
                                <li class="mix bestsellers">
                                    <div class="thumbnail thumbnail-product">
                                        ...
                                        <div class="caption">
                                            <div class="text-wrap">
                                                <h5><a href="{{ route('client.products.detail', ['id' => $item['uuid'], 'name' => str_replace(' ', '-', strtolower('New Product'))]) }}">{{ $item['name'] }}</a></h5>
                                                ...
                                                <div class="filter-list-disp">
                                                    ...
                                                    <a href="{{ route('client.products.detail', ['id' => $item['uuid'], 'name' => str_replace(' ', '-', strtolower('New Product'))]) }}" class="btn btn-default view-detail">View Details</a>
                                                </div>
                                            </div><!-- /text-wrap -->
                                            <div class="list-wrap">
                                                <h5>Highlights:</h5>
